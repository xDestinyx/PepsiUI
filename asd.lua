...
if game.CoreGui:FindFirstChild('Peachy Hub') then 
    game.CoreGui:FindFirstChild('Peachy Hub'):Destroy()
end 


local library = {
    Version = "0.35",
    WorkspaceName = "Peachy Hub",
    flags = {},
    signals = {},
    objects = {},
    elements = {},
    ...
    colors = {
        ...
        otherElementText = Color3.fromRGB(254, 0, 135),
        elementText = Color3.fromRGB(254, 0, 135),
        ...
        tabText = Color3.fromRGB(254, 0, 135)
    },
    gui_parent = (function()
...
function library:CreateWindow(options, ...)
    ...
    function windowFunctions:CreateTab(options, ...)
        ...
        function tabFunctions:CreateSection(options, ...)
            ...
            sectionHeadline.LineHeight = 0.87
            ...
            function sectionFunctions:AddLabel(options, ...)
                ...
                labelHeadline.Position = UDim2.fromScale(0.260, 0.165842161)
